...
title_combobox = ttk.Combobox(user_info_frame, values=["", "Mr.", "Ms.", "Dr."]) # use combobox to assigned value 
...
nationality_combobox = ttk.Combobox(user_info_frame, values=["Indian", "Pakistani", "Bangladeshi", "British", "American"]) # use combox to assigned country values
